...
const Footer = () => {
  ...
  {/* social links */}
   <nav className="w-full lg:flex-1 flex flex-col items-center justify-center gap-3">
  ...
  {/* subscribe */}
  <div className=" w-full lg:flex-1 flex flex-col gap-2 justify-center">
    <h4 className='flex lg:justify-start  text-md text-white font-semibold'>subscribe</h4>
    <div className="flex-1 flex lg:flex-row flex-col gap-3.5 justify-center flex-wrap">
