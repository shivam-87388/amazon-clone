...
const Footer = () => {
  ...
  <div className=" flex-1 flex flex-col gap-2 justify-center">
    <h4 className='flex lg:justify-start justify-center text-md text-white font-semibold'>subscribe</h4>
    <div className="flex-1 flex lg:flex-row flex-col  gap-3.5 flex-wrap ">
