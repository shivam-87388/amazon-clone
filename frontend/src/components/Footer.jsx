...
const Footer = () => {
  ...
  {/* subscribe */}
  <div className=" flex-1 flex flex-col gap-2 content-end">
    <h4 className='flex justify-start text-md text-white font-semibold'>subscribe</h4>
    <div className="flex-1 flex flex-row gap-3.5 flex-wrap">
    <input placeholder="email" className="flex-1 ring-white ring-2 py-2.5 px-1.5 rounded-md"></input>
    <button className=" px-2.5 py-1 bg-orange-400 text-white font-semibold text-lg rounded-md">submit</button>
    </div>
