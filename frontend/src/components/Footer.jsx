...
const Footer = () => {
  return (
   <footer className="flex px-6 py-14 bg-slate-900 items-center">
    <div className="w-full flex flex-row items-start justify-between gap-y-6 flex-wrap">
        <div className="w-full md:w-1/2 flex justify-center lg:flex-1 ">
         <img className="w-52 h-52 " src="/Gemini_Generated_Image_e2nvm6e2nvm6e2nv.png" alt="brandimage"/>
        </div>
         {/* navagation link */}
  <nav className="w-full md:w-1/2 lg:flex-1 flex flex-col justify-center items-center gap-3">
  ...
  {/* social links */}
   <nav className="w-full md:w-1/2 lg:flex-1 flex flex-col items-center justify-center gap-3">
  ...
  {/* subscribe */}
  <div className="flex w-full md:w-1/2 lg:flex-1 flex-col gap-2 lg:items-start items-center self-end ">
   
       <h4 className='text-md text-white font-semibold'>subscribe</h4>
    <div className="flex-1 flex flex-col lg:flex-row gap-3.5">
